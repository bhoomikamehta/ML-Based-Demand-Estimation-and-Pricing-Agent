...
- **Average time**: Should be well under 500ms (likely 10-50ms with optimizations)
- **Max time**: Should be ≤500ms
- **Status**: Should show "PASS"

The optimizations we made (using numpy arrays instead of pandas DataFrames) should make each decision much faster!
