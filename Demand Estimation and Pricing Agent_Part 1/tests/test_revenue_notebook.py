"""
Revenue test code - Copy this into a Jupyter notebook cell to test revenue performance
...
# Optional: Compare with baseline (uncomment to use)
# baseline_profit = 10000  # Set your baseline here
# improvement = ((profit_stats['mean'] - baseline_profit) / baseline_profit) * 100
